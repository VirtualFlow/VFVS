...
{% hint style="info" %}
Please note that the numbers in the _**Ligands**_ and _**Dockings**_ sections of the output of the `vf_report.sh` command only consider the completed collections. Collections currently in processing are not included yet in these counts.
{% endhint %}
...
\[For more information about monitoring the workflow in general, see the [_corresponding section_](https://docs.virtual-flow.org/documentation/-LdE8RH9UN4HKpckqkX3/using-virtualflow/monitoring) in the documentation.]
