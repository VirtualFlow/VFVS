        ...
        for docking_replica_index in $(seq ${docking_replica_index_start} ${docking_replica_index_end}); do
            ...
            case $docking_scenario_program in
                ...
                plants)
                    ...
                    sed -i "s|ligand_file.*|ligand_file ${VF_TMPDIR}/${USER}/VFVS/${VF_JOBLETTER}/${VF_QUEUE_NO_12}/${VF_QUEUE_NO}/input-files/ligands/pdbqt/${next_ligand_collection_metatranch}/${next_ligand_collection_tranch}/${next_ligand_collection_ID}/${next_ligand}.mol2|g" ${VF_TMPDIR}/${USER}/VFVS/${VF_JOBLETTER}/${VF_QUEUE_NO_12}/input-files/${docking_scenario_inputfolder}/config.txt
                    ...
                    sed -i "s|\.\.|${current_dir}/..|g" ${VF_TMPDIR}/${USER}/VFVS/${VF_JOBLETTER}/${VF_QUEUE_NO_12}/input-files/${docking_scenario_inputfolder}/config.txt
