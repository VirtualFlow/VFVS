...
#
# Revision history:
# 2017-04-08  Creation (based on the template1.torque.sh) (vfvs 9.9)
#
# ---------------------------------------------------------------------------
...
job_line=$(grep -m 1 "h_rt=" ../workflow/job-files/main/${VF_JOBLINE_NO}.job)
